  ...
  useEffect(() => {
    if (state.message) {
      if (state.success) {
        ...
        // Optionally reset form fields here if needed by managing form state outside useFormState
        // For simple reset, one might need to clear input values manually or wrap form in <form key={...}>
